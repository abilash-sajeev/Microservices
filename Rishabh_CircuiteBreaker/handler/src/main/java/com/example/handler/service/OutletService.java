...
public class OutletService  {
	...
	public List<Product> getProducts(){
		Product[] productsArray = restTemplate.getForObject("http://localhost:8080/GetProductInfo", Product[].class);
	...
	public Product getProduct(String id) {
		Product product = restTemplate.getForObject("http://localhost:8080/GetProductInfo/"+id, Product.class);
